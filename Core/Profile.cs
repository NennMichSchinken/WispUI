...
public sealed class Profile
{
    ...
    /// <c>BarStyle</c>, <c>Font</c>, <c>ShortenNames</c>,
    /// <c>MouseoverCasting</c>, <c>AuraNumberSize</c>, <c>FontName</c>,
    /// <c>TextWeight</c>, <c>TextEdge</c>, <c>Spacing</c> — migration relics, kept only so an old file can
    /// be read once — and <c>Mouseover</c>, which belongs to the hands at
